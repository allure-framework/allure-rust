...
fn md5_rfc_1321_test_vectors() {
    allure_test(module_path!(), "md5_rfc_1321_test_vectors", || {
...
fn md5_common_known_strings() {
    allure_test(module_path!(), "md5_common_known_strings", || {
        assert_md5(
...
fn md5_binary_and_unicode_inputs() {
    allure_test(module_path!(), "md5_binary_and_unicode_inputs", || {
...
#[test]
fn md5_large_inputs() {
    allure_test(module_path!(), "md5_large_inputs", || {
